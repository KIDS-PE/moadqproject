...
moa_consistency<-function(){
  ...
  clusterExport(cl, c('consistency_rule', 'mydbtype', 'myschemaname_lv1', 'myschemaname_lv2'))
  ...
  round1<-foreach(i=i1, .combine=rbind, .packages=c('dplyr', 'SqlRender', 'DBI'), .noexport="con", .options.snow = opts)%dopar%{
